            ...
            success: function(response) {
                ...
                if (response.success && response.data.length > 0) {
                    ...
                    tablaHistorico.DataTable({
                        ...
                        data: response.data, 
                        columns: [
                            { data: 'ID' }, { data: 'FECHA', render: function(data){ return formatDate(data); }},
                            { data: 'CLIENTE' }, { data: 'TEMA' }, { data: 'ASUNTO' },
                            { data: 'MOTIVO' }, { data: 'LIDER' }, { data: 'ENCARGADO' },
                            { data: 'ESTADO' }, { data: 'ACUMULADO', className: 'dt-body-right' },
                            { data: 'TIPOHORA' }
                        ],
